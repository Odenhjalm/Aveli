# LESSON AUDIO PLAYBACK EDGE CONTRACT
...
## AUDIO PLAYBACK OUTPUT SHAPE

Lesson audio playback output uses this serialized field order:
...
- No additional audio-specific resolver payload fields may be emitted
