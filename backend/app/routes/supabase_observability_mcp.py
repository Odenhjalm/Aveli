...
_TOOL_DEFINITIONS = [
    ...
    {
        "name": "get_supabase_domain_projections",
...
async def _call_tool(name: str, arguments: dict[str, Any]) -> dict[str, Any]:
    ...
    if name == "get_supabase_connection_health":
        return await supabase_observability.get_connection_health()
    if name == "get_supabase_auth_state":
        return await supabase_observability.get_auth_state()
    if name == "get_supabase_domain_projections":
        return await supabase_observability.get_domain_projections()
    if name == "get_supabase_storage_state":
        return await supabase_observability.get_storage_state()
    raise KeyError(name)
