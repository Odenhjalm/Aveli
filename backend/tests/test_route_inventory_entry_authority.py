...
NON_APP_ENTRY_ROUTE_CLASSIFICATIONS: dict[RouteKey, str] = {
    ...
    ("GET", "/mcp/supabase-observability"): "diagnostic_mcp",
    ("POST", "/mcp/supabase-observability"): "diagnostic_mcp",
    ("GET", "/mcp/stripe-observability"): "diagnostic_mcp",
    ("POST", "/mcp/stripe-observability"): "diagnostic_mcp",
    ("GET", "/mcp/netlify-observability"): "diagnostic_mcp",
    ("POST", "/mcp/netlify-observability"): "diagnostic_mcp",
