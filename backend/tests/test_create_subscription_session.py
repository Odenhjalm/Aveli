...
async def test_create_subscription_session(async_client, monkeypatch):
    ...
    os.environ["STRIPE_PRICE_MONTHLY"] = "price_month_test"
    ...
    def fake_price_retrieve(price_id):
        return {"id": price_id, "unit_amount": 9900, "currency": "sek"}
    ...
    assert captured_session.get("ui_mode") == (settings.stripe_checkout_ui_mode or "custom")
