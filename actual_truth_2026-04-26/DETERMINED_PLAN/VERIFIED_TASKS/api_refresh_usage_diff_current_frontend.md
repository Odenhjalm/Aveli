...
- Equivalent evidence expected in: `docs/audit/20260109_aveli_visdom_audit/API_USAGE_DIFF.md`, `docs/audit/20260109_aveli_visdom_audit/FRONTEND_REVIEW.md`, `actual_truth_2026-04-26/DETERMINED_PLAN/*`
...
- Create refreshed artifacts:
  ...
  dependent `actual_truth_2026-04-26/DETERMINED_PLAN/*` outputs
