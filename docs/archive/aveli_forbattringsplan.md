# Aveli – förbättringsrekommendationer och arbetsplan
...
6. **Rensa repo och förbättra dokumentationshygienen**
   - Problem: Backups och loggar ligger versionerade (`backup/aveli_dump_20251008_155345.sql`, `backend_uvicorn.log`), `.gitignore` innehåller kvarlämnat `EOF`, och dokument refererar fortfarande till "Visdom".
   - Åtgärder:
