...
- Import av kursinnehåll: `scripts/import_course.py` + manifest (YAML/JSON). Stöd för `cover_path` och flaggan `--create-assets-lesson` som lägger omslag i separat lektion (`_Course Assets`). Studentvyn döljer lektioner vars titel börjar med `_`.
