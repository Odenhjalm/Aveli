...
class _TestBackendAssetResolver extends BackendAssetResolver {
  _TestBackendAssetResolver() : super('');

  @override
  ImageProvider<Object> imageProvider(String assetPath, {double scale = 1.0}) {
    return MemoryImage(Uint8List.fromList(_transparentPng), scale: scale);
  }
}
