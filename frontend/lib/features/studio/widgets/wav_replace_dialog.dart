    ...
    return AlertDialog(
      ...
      content: ConstrainedBox(
        ...
        child: Column(
          ...
          children: [
            Text(
              'Ersätt "${widget.existingFileName}" genom att ladda upp en ny MP3-, WAV- eller M4A-fil. '
            ...
            if (_lastFinalState == 'failed') ...[
              const SizedBox(height: 12),
              Text(
                'Bearbetningen misslyckades. Du kan försöka igen genom att ladda upp en ny MP3-, WAV- eller M4A-fil.',
