...
void main() {
  ...
  testWidgets(
    'CourseEditorScreen inserts public-media images using download_url',
    (tester) async {
      ...
      final insertButton = find
          .byIcon(Icons.add_photo_alternate_outlined)
          .first;
  ...
  testWidgets(
    ...
    (tester) async {
        ...
        (_) async => [
          {
            ...
            'signed_url': '/media/stream/header.payload.signature',
            'download_url':
                '/api/files/course-media/course-1/lesson-1/image.png',
            'position': 1,
          },
        ],
      );
      ...
      expect(insertedUrl, contains('/media/stream/'));
    },
  );
