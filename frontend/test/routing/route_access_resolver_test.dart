...
void main() {
  group('resolveRouteAccessLevel', () {
    ...
    test('matches dynamic public routes', () {
      expect(
        resolveRouteAccessLevel('/course/some-slug'),
        RouteAccessLevel.public,
      );
      expect(
      ...
      expect(
        resolveRouteAccessLevel('/service/svc-1'),
        RouteAccessLevel.public,
      );
    });
    ...
    test('matches authenticated routes', () {
      ...
      expect(
        resolveRouteAccessLevel('/lesson/lesson-1'),
        RouteAccessLevel.authenticated,
      );
      expect(
        resolveRouteAccessLevel('/messages'),
        RouteAccessLevel.authenticated,
      );
      expect(
    ...
    test('defaults unknown routes to authenticated', () {
      expect(
        resolveRouteAccessLevel('/unknown'),
        RouteAccessLevel.authenticated,
      );
    });
  });
