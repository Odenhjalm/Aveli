...
void main() {
  ...
  test('fetchCoursePublicContent reads canonical description', () async {
    final harness = await _Harness.create();
    final repo = StudioRepository(client: harness.client);

    final publicContent = await repo.fetchCoursePublicContent(
      '99999999-9999-9999-9999-999999999999',
    );

    expect(publicContent.courseId, '99999999-9999-9999-9999-999999999999');
    expect(publicContent.description, 'Backend public description');
  ...
  test('upsertCoursePublicContent posts canonical public payload', () async {
    ...
    final publicContent = await repo.upsertCoursePublicContent(
      '99999999-9999-9999-9999-999999999999',
      description: 'Edited public description',
    );

    expect(publicContent.courseId, '99999999-9999-9999-9999-999999999999');
    expect(publicContent.description, 'Edited public description');
      ...
      if (options.path ==
        ...
        return _jsonResponse(
          ...
          body: {
            ...
            'description': 'Backend public description',
          },
        );
      }
      if (options.path ==
