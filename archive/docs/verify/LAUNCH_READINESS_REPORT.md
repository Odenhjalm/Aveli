...
live_events
order_type_bundle
postgrest_seminar_rpc
storage_buckets
- Migrations extra in DB: fix_livekit_job_id
rls_app_policies
...
## Remote DB Verify (read-only)
Status: FAILED
Reason: RLS/policy gaps,migration drift
- Master env: /home/oden/Aveli/backend/.env
- SUPABASE_DB_URL: set
- App tables: 59
- RLS disabled tables: media_assets
- Tables without policies: media_assets
- Storage buckets: audio_private (public=false)
brand (public=false)
course-media (public=false)
lesson-media (public=false)
