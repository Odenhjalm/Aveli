...
- Equivalent evidence expected in: `actual_truth_2026-04-24/auth/auth_system_rules.md`, `docs/audit/20260109_aveli_visdom_audit/E2E_FLOWS.md`, `docs/audit/20260109_aveli_visdom_audit/README.md`, `backend/app/routes/api_auth.py`, `backend/app/routes/email_verification.py`, `frontend/lib/api/auth_repository.dart`
...
- Open contract source files:
  `actual_truth_2026-04-24/auth/auth_system_rules.md`, `docs/audit/20260109_aveli_visdom_audit/E2E_FLOWS.md`, `docs/audit/20260109_aveli_visdom_audit/README.md`, `backend/app/routes/api_auth.py`, `backend/app/routes/email_verification.py`, `frontend/lib/api/auth_repository.dart`
