...
api_fix_checkout_session

---

## PROBLEM

- Frontend calls: POST /checkout/session
- Backend route is missing or mismatched for this path
- Equivalent handler expected in: `backend/app/routes/api_checkout.py`, `backend/app/routes/billing.py`
...
- Open route source files:
  `backend/app/routes/api_checkout.py`, `backend/app/routes/billing.py`
...
- be JSON
- match frontend usage context for checkout session creation
