...
- Equivalent evidence expected in: `actual_truth_2026-04-24/observability/mcp_observability_contract.md`, `docs/observability.md`, `docs/verification_mcp.md`, `docs/domain_observability_mcp.md`, `docs/media_control_plane_mcp.md`
