...
- `.vscode/mcp.json`
- `actual_truth_2026-04-24/DETERMINED_PLAN/VERIFIED_TASKS/*`
...
- Pre-check trigger:
  - For every task derived from `actual_truth_2026-04-24/DETERMINED_PLAN/VERIFIED_TASKS/*`, call `semantic-search` to load prior verified context.
